...
function getObservedMinSinceMidnightCandidate(
  ...
  const directCandidates: Array<[string, unknown, string]> = [
    ["hkoMinSinceMidnightC", forecastRecord.hkoMinSinceMidnightC, "HKO min since midnight"],
    ["minSinceMidnightC", forecastRecord.minSinceMidnightC, "HKO min since midnight"],
    ["observedMinC", forecastRecord.observedMinC, "Observed min so far"],
    ["observedMin", forecastRecord.observedMin, "Observed min so far"],
    ["observedMinSoFarC", forecastRecord.observedMinSoFarC, "Observed min so far"],
    ["observedMinSoFar", forecastRecord.observedMinSoFar, "Observed min so far"],
  ...
  const pathCandidates: Array<[string, string[], string]> = [
    ["weather.sinceMidnight.minTempC", ["weather", "sinceMidnight", "minTempC"], "HKO min since midnight"],
    ["weather.sinceMidnight.minTemperatureC", ["weather", "sinceMidnight", "minTemperatureC"], "HKO min since midnight"],
    ["weather.sinceMidnight.minTemp", ["weather", "sinceMidnight", "minTemp"], "HKO min since midnight"],
    ["weather.sinceMidnight.minTemperature", ["weather", "sinceMidnight", "minTemperature"], "HKO min since midnight"],
    ["weather.hkoMinSinceMidnightC", ["weather", "hkoMinSinceMidnightC"], "HKO min since midnight"],
    ["weather.minSinceMidnightC", ["weather", "minSinceMidnightC"], "HKO min since midnight"],
    ["weather.minSoFarC", ["weather", "minSoFarC"], "Observed min so far"],
    ["weather.observedMinSoFarC", ["weather", "observedMinSoFarC"], "Observed min so far"],
    ["weather.observedMinC", ["weather", "observedMinC"], "Observed min so far"],
    ["weather.todayMinC", ["weather", "todayMinC"], "Observed min so far"],
    ["weather.current.minSoFarC", ["weather", "current", "minSoFarC"], "Observed min so far"],
    ["weather.current.todayMin", ["weather", "current", "todayMin"], "Observed min so far"],
    ["weather.current.minTemperature", ["weather", "current", "minTemperature"], "Observed min so far"],
    ["weather.current.minTemperatureC", ["weather", "current", "minTemperatureC"], "Observed min so far"],
    ["hko.minSinceMidnightC", ["hko", "minSinceMidnightC"], "HKO min since midnight"],
    ["hko.hkoMinSinceMidnightC", ["hko", "hkoMinSinceMidnightC"], "HKO min since midnight"],
    ["weatherSnapshot.minSinceMidnightC", ["weatherSnapshot", "minSinceMidnightC"], "HKO min since midnight"],
    ["hkoWeatherSnapshot.minSinceMidnightC", ["hkoWeatherSnapshot", "minSinceMidnightC"], "HKO min since midnight"],
    ["diagnostics.minSoFarC", ["diagnostics", "minSoFarC"], "Observed min so far"],
    ["diagnostics.observedMinSoFarC", ["diagnostics", "observedMinSoFarC"], "Observed min so far"],
    ["diagnostics.hkoMinSinceMidnightC", ["diagnostics", "hkoMinSinceMidnightC"], "HKO min since midnight"],
  ];
...
function getOfficialForecastMaxCandidate(
  ...
  const directCandidates: Array<[string, unknown, string]> = [
    ["officialForecastMaxC", forecastRecord.officialForecastMaxC, "HKO official forecast max"],
    ["hkoOfficialForecastMaxC", forecastRecord.hkoOfficialForecastMaxC, "HKO official forecast max"],
    ["forecastMaxC", forecastRecord.forecastMaxC, "HKO official forecast max"],
    ["hkoForecastMaxC", forecastRecord.hkoForecastMaxC, "HKO official forecast max"],
    ["officialForecastMax", forecastRecord.officialForecastMax, "HKO official forecast max"],
    ["forecastMax", forecastRecord.forecastMax, "HKO official forecast max"],
  ];

  const pathCandidates: Array<[string, string[], string]> = [
    ["weather.officialForecastMaxC", ["weather", "officialForecastMaxC"], "HKO official forecast max"],
    ["weather.hkoOfficialForecastMaxC", ["weather", "hkoOfficialForecastMaxC"], "HKO official forecast max"],
    ["weather.forecastMaxC", ["weather", "forecastMaxC"], "HKO official forecast max"],
    ["weather.hkoForecastMaxC", ["weather", "hkoForecastMaxC"], "HKO official forecast max"],
    ["weather.forecastMax", ["weather", "forecastMax"], "HKO official forecast max"],
    ["weather.forecastMaxtemp.value", ["weather", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["weather.forecastMaxtemp", ["weather", "forecastMaxtemp"], "HKO official forecast max"],
    ["weather.forecastMaxTemp.value", ["weather", "forecastMaxTemp", "value"], "HKO official forecast max"],
    ["weather.forecastMaxTemperature.value", ["weather", "forecastMaxTemperature", "value"], "HKO official forecast max"],
    ["weather.forecast.maxTempC", ["weather", "forecast", "maxTempC"], "HKO official forecast max"],
    ["weather.forecast.maxTemperatureC", ["weather", "forecast", "maxTemperatureC"], "HKO official forecast max"],
    ["weather.forecast.forecastMaxtemp.value", ["weather", "forecast", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["weather.localForecast.forecastMaxC", ["weather", "localForecast", "forecastMaxC"], "HKO official forecast max"],
    ["weather.localForecast.forecastMaxtemp.value", ["weather", "localForecast", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["weather.nineDayWeatherForecast.0.forecastMaxtemp.value", ["weather", "nineDayWeatherForecast", "0", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["weather.weatherForecast.0.forecastMaxtemp.value", ["weather", "weatherForecast", "0", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["weather.raw.nineDayWeatherForecast.0.forecastMaxtemp.value", ["weather", "raw", "nineDayWeatherForecast", "0", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["weather.raw.weatherForecast.0.forecastMaxtemp.value", ["weather", "raw", "weatherForecast", "0", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["hko.officialForecastMaxC", ["hko", "officialForecastMaxC"], "HKO official forecast max"],
    ["hko.hkoOfficialForecastMaxC", ["hko", "hkoOfficialForecastMaxC"], "HKO official forecast max"],
    ["hko.forecastMaxC", ["hko", "forecastMaxC"], "HKO official forecast max"],
    ["hko.forecastMaxtemp.value", ["hko", "forecastMaxtemp", "value"], "HKO official forecast max"],
    ["diagnostics.officialForecastMaxC", ["diagnostics", "officialForecastMaxC"], "HKO official forecast max"],
    ["diagnostics.hkoOfficialForecastMaxC", ["diagnostics", "hkoOfficialForecastMaxC"], "HKO official forecast max"],
  ];
...
function getHourlyRainfallCandidate(
  ...
  const directCandidates: Array<[string, unknown, string]> = [
    ["hourlyRainfallMm", forecastRecord.hourlyRainfallMm, "HKO hourly rainfall"],
    ["rainfallLastHourMm", forecastRecord.rainfallLastHourMm, "HKO hourly rainfall"],
    ["rainfallPastHourMm", forecastRecord.rainfallPastHourMm, "HKO hourly rainfall"],
    ["rainHourlyMm", forecastRecord.rainHourlyMm, "HKO hourly rainfall"],
    ["rainfallMm", forecastRecord.rainfallMm, "HKO hourly rainfall"],
    ["rainfall", forecastRecord.rainfall, "HKO hourly rainfall"],
  ];

  const pathCandidates: Array<[string, string[], string]> = [
    ["weather.hourlyRainfallMm", ["weather", "hourlyRainfallMm"], "HKO hourly rainfall"],
    ["weather.rainfallLastHourMm", ["weather", "rainfallLastHourMm"], "HKO hourly rainfall"],
    ["weather.rainfallPastHourMm", ["weather", "rainfallPastHourMm"], "HKO hourly rainfall"],
    ["weather.rainHourlyMm", ["weather", "rainHourlyMm"], "HKO hourly rainfall"],
    ["weather.rainfallMm", ["weather", "rainfallMm"], "HKO hourly rainfall"],
    ["weather.rainfall", ["weather", "rainfall"], "HKO hourly rainfall"],
    ["weather.rainfall.value", ["weather", "rainfall", "value"], "HKO hourly rainfall"],
    ["weather.rain.hourlyRainfallMm", ["weather", "rain", "hourlyRainfallMm"], "HKO hourly rainfall"],
    ["weather.rain.rainfallLastHourMm", ["weather", "rain", "rainfallLastHourMm"], "HKO hourly rainfall"],
    ["weather.rain.rainfallMm", ["weather", "rain", "rainfallMm"], "HKO hourly rainfall"],
    ["weather.current.hourlyRainfallMm", ["weather", "current", "hourlyRainfallMm"], "HKO hourly rainfall"],
    ["weather.current.rainfallLastHourMm", ["weather", "current", "rainfallLastHourMm"], "HKO hourly rainfall"],
    ["hko.hourlyRainfallMm", ["hko", "hourlyRainfallMm"], "HKO hourly rainfall"],
    ["hko.rainfallLastHourMm", ["hko", "rainfallLastHourMm"], "HKO hourly rainfall"],
    ["diagnostics.hourlyRainfallMm", ["diagnostics", "hourlyRainfallMm"], "HKO hourly rainfall"],
  ];
...
function getObservedMaxLowerBoundCandidate(
  ...
  const directCandidates: Array<[string, unknown, string]> = [
    ["observedMaxLowerBoundC", forecastRecord.observedMaxLowerBoundC, "Observed max lower bound"],
    ["observedFinalMaxLowerBoundC", forecastRecord.observedFinalMaxLowerBoundC, "Observed max lower bound"],
    ...
    ["hkoMaxSinceMidnightC", forecastRecord.hkoMaxSinceMidnightC, "HKO max since midnight"],
    ["maxSinceMidnightC", forecastRecord.maxSinceMidnightC, "HKO max since midnight"],
    ["maxSoFarC", forecastRecord.maxSoFarC, "Observed max so far"],
    ["maxSoFar", forecastRecord.maxSoFar, "Observed max so far"],
    ["observedMaxSoFarC", forecastRecord.observedMaxSoFarC, "Observed max so far"],
    ["observedMaxSoFar", forecastRecord.observedMaxSoFar, "Observed max so far"],
    ["hkoCurrentTempC", forecastRecord.hkoCurrentTempC, "HKO current temperature fallback"],
    ["currentTempC", forecastRecord.currentTempC, "HKO current temperature fallback"],
    ["currentTemperatureC", forecastRecord.currentTemperatureC, "HKO current temperature fallback"],
  ];

  const pathCandidates: Array<[string, string[], string]> = [
    ["weather.sinceMidnight.maxTempC", ["weather", "sinceMidnight", "maxTempC"], "HKO max since midnight"],
    ["weather.sinceMidnight.maxTemperatureC", ["weather", "sinceMidnight", "maxTemperatureC"], "HKO max since midnight"],
    ["weather.sinceMidnight.maxTemp", ["weather", "sinceMidnight", "maxTemp"], "HKO max since midnight"],
    ["weather.sinceMidnight.maxTemperature", ["weather", "sinceMidnight", "maxTemperature"], "HKO max since midnight"],
    ["weather.observedMaxLowerBoundC", ["weather", "observedMaxLowerBoundC"], "Observed max lower bound"],
    ["weather.observedFinalMaxLowerBoundC", ["weather", "observedFinalMaxLowerBoundC"], "Observed max lower bound"],
    ["weather.observedMaxC", ["weather", "observedMaxC"], "Observed max so far"],
    ["weather.observedMax", ["weather", "observedMax"], "Observed max so far"],
    ["weather.maxSoFarC", ["weather", "maxSoFarC"], "Observed max so far"],
    ["weather.observedMaxSoFarC", ["weather", "observedMaxSoFarC"], "Observed max so far"],
    ["weather.hkoMaxSinceMidnightC", ["weather", "hkoMaxSinceMidnightC"], "HKO max since midnight"],
    ["weather.maxSinceMidnightC", ["weather", "maxSinceMidnightC"], "HKO max since midnight"],
    ["weather.hkoCurrentTempC", ["weather", "hkoCurrentTempC"], "HKO current temperature fallback"],
    ["weather.current.hkoCurrentTempC", ["weather", "current", "hkoCurrentTempC"], "HKO current temperature fallback"],
    ["weather.current.currentTempC", ["weather", "current", "currentTempC"], "HKO current temperature fallback"],
    ["weather.current.tempC", ["weather", "current", "tempC"], "HKO current temperature fallback"],
    ["weather.current.temperatureC", ["weather", "current", "temperatureC"], "HKO current temperature fallback"],
    ["weather.current.temperature", ["weather", "current", "temperature"], "HKO current temperature fallback"],
    ["weather.current.temperature.value", ["weather", "current", "temperature", "value"], "HKO current temperature fallback"],
    ["weather.current.airTemperatureC", ["weather", "current", "airTemperatureC"], "HKO current temperature fallback"],
    ["weather.current.maxSoFarC", ["weather", "current", "maxSoFarC"], "Observed max so far"],
    ["weather.current.todayMax", ["weather", "current", "todayMax"], "Observed max so far"],
    ["weather.current.maxTemperature", ["weather", "current", "maxTemperature"], "Observed max so far"],
    ["weather.currentTempC", ["weather", "currentTempC"], "HKO current temperature fallback"],
    ["weather.currentTemperatureC", ["weather", "currentTemperatureC"], "HKO current temperature fallback"],
    ["weather.temperatureC", ["weather", "temperatureC"], "HKO current temperature fallback"],
    ["weather.temperature", ["weather", "temperature"], "HKO current temperature fallback"],
    ["hko.currentTempC", ["hko", "currentTempC"], "HKO current temperature fallback"],
    ["hko.maxSinceMidnightC", ["hko", "maxSinceMidnightC"], "HKO max since midnight"],
    ["weatherSnapshot.observedMaxC", ["weatherSnapshot", "observedMaxC"], "Observed max so far"],
    ["weatherSnapshot.maxSinceMidnightC", ["weatherSnapshot", "maxSinceMidnightC"], "HKO max since midnight"],
    ["weatherSnapshot.currentTempC", ["weatherSnapshot", "currentTempC"], "HKO current temperature fallback"],
    ["hkoWeatherSnapshot.observedMaxC", ["hkoWeatherSnapshot", "observedMaxC"], "Observed max so far"],
    ["hkoWeatherSnapshot.maxSinceMidnightC", ["hkoWeatherSnapshot", "maxSinceMidnightC"], "HKO max since midnight"],
    ["hkoWeatherSnapshot.currentTempC", ["hkoWeatherSnapshot", "currentTempC"], "HKO current temperature fallback"],
    ["diagnostics.maxSoFarC", ["diagnostics", "maxSoFarC"], "Observed max so far"],
    ["diagnostics.observedMaxSoFarC", ["diagnostics", "observedMaxSoFarC"], "Observed max so far"],
    ["diagnostics.hkoCurrentTempC", ["diagnostics", "hkoCurrentTempC"], "HKO current temperature fallback"],
  ];
...
function buildRawOutcomeRows(params: {
  ...
  if (!stateRows.length) {
    return {
      rows: forecastRows,
      source: Array.isArray(params.forecastRecord.outcomeProbabilities)
    ...
    try {
      ...
      const forecastForAi = {
        ...
        multiChannelForecastJson: buildMultiChannelForecastJson(
          normalizedForAi as ForecastResult
        ),
        diagnostics: {
          ...recordOrEmpty(
